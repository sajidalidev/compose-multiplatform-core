 ...
 * points-to-pixels factor used for touch positions, interop hit tests and placement, insets,
 ...
 * and `IosInteropElementHolder` places native interop views by dividing root pixels by that same
