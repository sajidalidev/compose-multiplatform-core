...
object JetBrainsPublication {
    ...
    val libraryToComponents: Map<String, List<ComposeComponent>> get() = mapOf(
        ...
        // keep this port's surface minimal; see task-23a-report.md). Js and WasmJs were added on
        // top for the Tizen web target (js() and wasmJs() targets added to
        // tv/tv-material/build.gradle) so this component's Js/WasmJs publications
        // (tv-material-js, tv-material-wasm-js) actually get generated.
        "TV_MATERIAL" to listOf(
            ComposeComponent(
                ":tv:tv-material",
                supportedPlatforms = ComposePlatforms.ANDROID + ComposePlatforms.TV_OS + ComposePlatforms.Js + ComposePlatforms.WasmJs
            ),
        ),
    )
